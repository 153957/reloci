...
class PlannerTestCase(unittest.TestCase):
    ...
    def test_get_files(self) -> None:
        self.assertCountEqual(
            [
                ...
                self.source / 'IMG_0805.HEIC',
                self.source / 'IMG_0807.mov',
    ...
    def test_get_output_path(self) -> None:
        combinations = [
            ...
            # Phone
            ('IMG_0805.HEIC', '2026/08/260812/CTX_msqfxw2b.HEIC'),
            ('IMG_0807.mov', '2026/08/260812/CTX_msqfxyqg.mov'),  # No counterpart, uses less accurate timestamp
